...
|------------|------------|------------|
| Basic familiarity with Open Science concepts and practices | Examples: Replication crisis, open access, R, version control, preregistration, etc.| [OSC Website](https://lmu-osc.github.io/train-the-trainer-student-track-OS/) |
| Core didactic principles | A firm grasp on didactic tools | [OSC Website](https://lmu-osc.github.io/train-the-trainer-student-track-pedagogy/teaching-open-research/core-didactic-principles/) |
</div>
...
<br>
*Go to Section 1 of the Open Science Workshop workbook and navigate to exercise B3. Write down your thoughts. Take 3 minutes for this exercise.*
...
![](images/empathy.png){fig-align="center" fig-alt="icon representing feedback bubbles" width=40%}
...
::: {.notes}
**Presenter Notes**: The main take-home from providing feedback is that your words matter, so it is important to choose them wisely.
