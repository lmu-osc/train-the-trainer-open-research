...
For **this session**, it is important that you have previously thought about didactics and incorporating pedagogical elements in your teaching. You should be familiar with the basics of what learning means, the framework of constructivism, constructive alignment and how to set and formulate learning objectives. You should also be familiar with evidence-based methods to plan and structure your open research event. If you are not yet familiar with these concepts, please see the previous session on "Core didactic principles" and "Concept planning" when teaching about Open Research or Open Science.
...
These are the prerequisites for this session. Before you get started on this session with your audience, you need to ensure that the audience fulfills these criteria.
...
**What is your experience with actively creating a positive learning environment for your learners in OR events?**
...
**What does "learning environment" mean to you?**
...
::: {.notes}
**Presenter Notes**: First question to you as the audience: What does the term learning environment mean to you? What thoughts or concepts come to mind? Take 3 minutes to collect some concepts and thoughts that come to mind.

**Instructor Notes**: Check prior knowledge and existing concepts with this question. Use a tool to create a wordcloud where you type your learners answers, or collect thoughts on a whiteboard, depending on the setting.
:::
...
Research suggests that a positive learning environment can support learner engagement and success. This is why it is useful to think about not only what we teach, but also the conditions in which learning happens. Different aspects shape how people experience learning. For example, whether learners feel respected, included, supported, and able to participate can influence their engagement with the course.
...
- Influences **well-being** (psychological and physical)
...
The learning environment also affects well-being, in the physical and the psychological sense. When learners feel supported, respected, and safe, they are generally better able to participate and learn.
:::
...
::: {.notes}
**Presenter Notes**: Its impact can extend beyond the event or course itself. Positive learning environments are associated with better long-term knowledge retention and the development of competencies that learners can apply in their professional roles.
...
::: {.notes}
**Presenter Notes**: Time for an activity! What is a positive learning environment to you? What elements are in there? With a partner, write a few bullet points on your thoughts and what you connect with this concept.

**Instructor Notes**: Plan about 5 minutes for this activity. Some possible elements of a positive learning environment, see for example the three dimensions of  Rusticus et al., 2023 from a learners perspective: personal development (active learning in class, practical applications of their learning, visuals, realistic expectations); relationships (faculty support, peer interaction, group work); and institutional setting (physical structure, expectations and culture of environment, community, smaller class sizes). Take 2 minutes to discuss in the big group.
:::
...
<div style="background-color: #f0f0f0; padding: 0.1em; border-radius: 5px; font-size: 1em; text-align: center;">
"... **listening with attention and intention** to understand another person’s message, while **showing** understanding through responses such as clarification, and reflection."
</div>
...
**Instructor Notes**: Highlight active listening as a transferable skill.
:::
...
Beware that the meaning and interpretation of eye contact, gestures, and personal space can vary, so being aware of these differences can help support respectful and inclusive communication. For example, in many Western cultures like Germany, Canada etc. direct eye contact is a sign of confidence and engagement, whereas in other cultures it could be considered confrontational in parts of Japan and South Korea.
:::
...
- How did you first come across Open Research?

- What is your favorite Open Research practice and why?

:::footer
Form groups of three: One "learner", one instructor, one the observer. Instructor practices active listening while learner answers question (2 mins). After, discuss observations and something that surprised you (2 mins).
:::
...
**Instructor Notes**: Leave about 5 - 7 minutes for this exercise, plus about 2 minutes for discussion in the big group. Discussion points: virtual vs. in-person setting: what is different? Active listening is more challenging in virtual environments, because ordinary listening and visual cues are weakened online. However, it is still very much possible. Key verbal strategies can still be used, for example paraphrasing, summaries, reflections, or clarifying questions However, you might need to make your body language more visible, or use reaction emojis to demonstrate non-verbally that you are actively listening, and be more directive when turn-taking or handing over the word ("I would like to hand over the word to X person.."), since those conversational cues are easily missed in virtual settings. Also encourage everyone to have their camera on, to strengthen the visual cues.
:::
...
**Instructor Notes**: Allow approx. 5 minutes for this exercise, apply think-pair-share, two minutes each [@mundelseeThinkPairShare2021]. Discuss as a group in the "share" phase.
:::
...
In a positive learning environment, inclusive language helps create opportunities for everyone to participate and contribute. As instructors, we are the ones choosing the language we use during our teaching. 
:::
...
- Depending on the topic, multiple instructors might make the event run more smoothly (e.g., when teaching computational reproducibility)

- Select a **diverse team** of instructors/facilitators (if you can)
  - Your audience will be able to **relate** more to some

::: {.notes}
**Presenter Notes**: You do not have to teach alone! Especially for Open Research practices or computational reproducibility, teaching with two or three or more can make all the difference and signficantly decrease the pressure on you. When you are choosing facilitators or co-instructors, aim for a diverse skills set and a diverse background. Your audience will get a lot out of the variety in skills present in the room and, depending on their own background, will always find someone they can relate to the most.
:::
...
**Instructor Notes**: Plan about 5 minutes for this activity, plus 2 minutes for discussion.
:::
