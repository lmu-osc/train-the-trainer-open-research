...
|------------|------------|------------|
| Basic familiarity with Open Research concepts and practices | Examples: Replication crisis, open access, R, version control, preregistration, etc.| [Click here to get familiar with Open Research first](https://lmu-osc.github.io/training/self-learning.html) |
</div>
...
Before you get started on this session with your audience, you need to ensure that the audience fulfills these criteria. Also outline any essential prerequisites (software, tools, other submodules etc.) here. 
...
:::footer
See @lovettHowLearningWorks2023 and @efgiviaAnalysisConstructivismLearning2021. Slide adapted from Laura Carter: "Evidence-based Training" [https://zenodo.org/records/18905547](https://zenodo.org/records/18905547). Slide originally licensed under CC BY 4.0: [https://creativecommons.org/licenses/by/4.0/](https://creativecommons.org/licenses/by/4.0/)  
:::
...
<td>Knows which "default licenses" are a good choice for most typical cases</td>
<td>Explain specific details of licences or handle "untypical" licensing cases</td>
</tr>
<tr>
...
:::{.timer #think1 seconds=180 starton=interaction size=40% sound=true}
::: 
...
:::{.timer #pair1 seconds=240 starton=interaction size=40% sound=true}
:::
...
:::{.timer #share1 seconds=240 starton=interaction size=40% sound=true}
:::
...
![](images/constructive-alignment.png){width="100%" fig-align="center" fig-alt="figure depicting the pyramid of constructive alignment, with assessment tasks and teaching activities as separate elements on the bottom layer, and learning objectives as the top layer, all connected through arrows"}
...
![](images/constructive-alignment-preprint-example.png){width="100%" fig-align="center" fig-alt="figure depicting the pyramid of constructive alignment, with assessment tasks and teaching activities as separate elements on the bottom layer, and learning objectives as the top layer, all connected through arrows illustrated via the example of compiling metadata for a preprint as learning objective"}
...
Please cite as: Von Grebmer zu Wolfsthurn, S., Middleton, S., Ihle, M., & Schönbrodt, F. (2026). *Teaching open research: Core didactic principles* [Quarto slides]. LMU Open Science Center. [https://lmu-osc.github.io/train-the-trainer-open-research/teaching-open-research/core-didactic-principles/](https://lmu-osc.github.io/train-the-trainer-open-research/teaching-open-research/core-didactic-principles/)
</div>
