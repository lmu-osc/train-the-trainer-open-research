...
- **Formulate** concrete learning objectives according to specific learning domains for real-world content - *time-dependent*
:::
...
## Bonus activity: Designing assessment tasks
...
::: {.notes}
**Presenter Notes**: This is a bonus activity. In pairs, design one assessment task for each learning objective (cognitive, affective, psychomotor). For each assessment, specify:
